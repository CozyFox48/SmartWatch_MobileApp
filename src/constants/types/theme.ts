...
export interface ThemeColors {
  ...
  success: ColorValue;
  info: ColorValue;
  danger_light: ColorValue;
  warning_light: ColorValue;
  // success_light: ColorValue;
  info_light: ColorValue;
  danger_middle: ColorValue;
  warning_middle: ColorValue;
  // success_light: ColorValue;
  info_middle: ColorValue;
  card: ColorValue;
